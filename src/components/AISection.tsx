...
const agents = [
  { name: "GPT-Помощник", isAgent: true, selected: true, icon: "◇" },
  { name: "НовостиБот", isAgent: true, selected: false, icon: "◉" },
  { name: "ПогодаБот", isAgent: true, selected: false, icon: "◈" },
  { name: "Алиса", isAgent: false, selected: false, icon: "○" },
  { name: "ФинансыБот", isAgent: true, selected: false, icon: "◎" },
  { name: "Максим", isAgent: false, selected: false, icon: "○" },
]
      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          >
            ...
            <span className="text-zinc-400 text-sm">Экосистема ботов</span>
          ...
          >
            <span className="text-white font-medium">Каталог ботов Vibe.</span> Подключай ботов прямо в чаты и группы — от умного ГПТ-ассистента до погоды, новостей и личных финансов.
          </motion.p>
            ...
            >
              ...
              >
                ...
                <div className="bg-zinc-800/50 border border-zinc-700 rounded-t-xl px-5 py-4">
                  <span className="text-zinc-500 italic">Добавить бота в чат...</span>
                </div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="border-t border-r border-b border-zinc-800/60 pt-12 pr-12 pb-16">
                <h3 className="text-zinc-200 font-medium text-xl mb-3">Умные подсказки от ботов</h3>
                <p className="text-zinc-500 text-base mb-8">
                  Бот сам предложит нужный ответ, напомнит о встрече или отправит сводку новостей.
                </p>
                ...
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5">
                  <div className="flex items-center gap-2 mb-5">
                    ...
                    <span className="text-zinc-500 text-sm">
                      Авто <span className="text-zinc-300">ответы бота</span>
                    </span>
                  </div>

                  {/* Suggestions Row */}
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-zinc-600 text-sm w-20">Предложение</span>
                  ...
                  <div className="bg-zinc-800/40 rounded-lg p-4 ml-4">
                    ...
                    <p className="text-zinc-500 text-xs mb-2">Почему этот бот</p>
                    <p className="text-zinc-500 text-sm mb-4">
                      GPT-Помощник отвечает на вопросы, помогает с текстами и генерирует идеи прямо в чате
                    </p>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <span className="flex items-center gap-1.5 bg-zinc-700/50 rounded-md px-2 py-1 text-sm">
                        ...
                        <span className="text-zinc-400">НовостиБот</span>
                      </span>
                      <span className="flex items-center gap-1.5 bg-zinc-700/50 rounded-md px-2 py-1 text-sm">
                        <span className="w-4 h-4 bg-zinc-500 rounded-full" />
                        <span className="text-zinc-400">ПогодаБот</span>
                      </span>
                    </div>
              ...
              <div className="border-t border-b border-zinc-800/60 pt-12 pl-12 pb-16">
                <h3 className="text-zinc-200 font-medium text-xl mb-3">API для разработчиков ботов</h3>
                <p className="text-zinc-500 text-base mb-8">
                  Создавай своих ботов и публикуй в каталоге Vibe — миллионы пользователей сразу.
                </p>

                {/* API Code Snippet */}
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5 font-mono text-sm">
                  <p className="text-zinc-700 mb-3">// api.vibe.app/v1/bot</p>
                  <div className="space-y-1 mb-6">
                    <p>
                      <span className="text-orange-400/70">"webhook"</span>
                      <span className="text-zinc-500">: {"{"}</span>
                    </p>
                    <p className="pl-4">
                      <span className="text-orange-400/70">"url"</span>
                      <span className="text-zinc-500">: </span>
                      <span className="text-green-400/70">"https://mybot.app"</span>
                    </p>
                    <p className="pl-4">
                      <span className="text-orange-400/70">"token"</span>
                      <span className="text-zinc-500">: </span>
                      <span className="text-green-400/70">"vibe_bot_****"</span>
                    </p>
                  </div>
                  ...
                  <div className="bg-zinc-800/40 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-zinc-600">Напишите боту...</span>
                    </div>
