export function Footer() {
  const footerLinks = {
    "Возможности": ["Чаты", "Боты", "Голосовые звонки", "Видеозвонки", "Каналы", "Безопасность", "Мобильное приложение"],
    "Продукт": ["Тарифы", "Каталог ботов", "Интеграции", "Новинки", "Документация", "Скачать", "Перейти в Vibe"],
    "Компания": ["О нас", "Пресса", "Карьера", "Новости", "Ценности", "Качество", "Бренд"],
    "Ресурсы": ["API для разработчиков", "Статус сервиса", "Для бизнеса", "Сообщить об уязвимости", "Конфиденциальность", "Условия"],
    "Связаться": ["Поддержка", "Сообщество", "Telegram", "VK", "YouTube"],
  }
