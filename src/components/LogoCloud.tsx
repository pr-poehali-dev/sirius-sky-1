...
const companies = [
  { name: "Новости 24", icon: Zap },
  { name: "WeatherBot", icon: Globe },
  { name: "FinanceBot", icon: Diamond },
  { name: "AstroBot", icon: Star },
  { name: "GPT-Помощник", icon: Sparkles },
  { name: "SportBot", icon: Hexagon },
  { name: "MusicBot", icon: Circle },
  { name: "ShopBot", icon: Square },
]
    ...
    <div className="relative z-20 pb-24 pt-8" style={{ backgroundColor: "#09090B" }}>
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-4xl text-center">
          ...
          >
            Уже тысячи пользователей общаются в Vibe каждый день.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Один мессенджер — безграничные возможности с ботами.
          </motion.p>
