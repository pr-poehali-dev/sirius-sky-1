...
const featureCards = [
  {
    title: "Умные боты в каждом чате",
    illustration: (
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
            ...
            >
              <p className="text-zinc-400 leading-relaxed">
                Vibe объединяет привычный мессенджер с мощной экосистемой ботов:
                автоматизируй, развлекайся и будь в курсе всего важного.{" "}
                <a href="#" className="text-white inline-flex items-center gap-1 hover:underline">
                  Скачать Vibe <ChevronRight className="w-4 h-4" />
                </a>
              </p>
            </motion.div>
          </div>
